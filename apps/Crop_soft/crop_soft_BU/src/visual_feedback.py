...
class visual_feedback(Canvas):
    ...
    def __init__(self, parent, file):
        ...
        #self.draw()
        self.dict_rect = {"BU1" : [self.create_rectangle(0,0,0,0, outline="red"), [0, 0, 0, 0], [0, 0, 0, 0]],\
                          "BU2" : [self.create_rectangle(0,0,0,0, outline="green"),[0, 0, 0, 0],[0, 0, 0, 0]],\
                          "BU3" : [ self.create_rectangle(0,0,0,0, outline="blue"),[0, 0, 0, 0], [0, 0, 0, 0]]}
