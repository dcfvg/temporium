...
if __name__ == "__main__":
    ...
    """
    time.sleep(10)
    server.client_connected["client_analyse_image"]._send("test 1")
    time.sleep(2)
    server.client_connected["client_analyse_image"]._send("test 2")
    time.sleep(2)
    server.client_connected["client_analyse_image"]._send("test 2")
    time.sleep(2)
    server.client_connected["client_analyse_image"]._send("test 2")
    ...
    server.client_connected["client_analyse_image"]._send("test 2")
    time.sleep(4)
    server.client_connected["client_analyse_image"]._send("test 3")
    """
    #time.sleep(3)
    #server.client_connected["client_analyse_image"]._send("test 2")
