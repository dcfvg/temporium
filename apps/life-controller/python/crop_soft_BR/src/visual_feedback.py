...
class visual_feedback(Canvas):
    ...
    """get the coord of the drawn rect"""
    def get_rect_image(self, name):
        """make sure that it return North-West point, then South-East point"""
        if int(self.dict_rect[name][1][0]*self.image_size_x) <= int(self.dict_rect[name][1][2]*self.image_size_x) :  
            ...
            coord = [int(self.dict_rect[name][1][2]*self.image_size_x),\
                     int(self.dict_rect[name][1][3]*self.image_size_y),\
                     int(self.dict_rect[name][1][0]*self.image_size_x),\
                     int(self.dict_rect[name][1][1]*self.image_size_y)] 
