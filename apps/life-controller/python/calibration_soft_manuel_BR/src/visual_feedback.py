...
class visual_feedback(Canvas):
    ...
    def __init__(self, parent, file):
        ...
        self.dict_line_level_high = {"BR1" :  [0, [0,0,0,0],self.create_line(0,0,0,0, fill="white")],\
                               "BR2" :  [0, [0,0,0,0],self.create_line(0,0,0,0, fill="white")],\
                               "BR3" :  [0, [0,0,0,0],self.create_line(0,0,0,0, fill="white")]}
        
        """line for showing level"""
        self.dict_line_level_low = {"BR1" :  [0, [0,0,0,0],self.create_line(0,0,0,0, fill="white")],\
                               "BR2" :  [0, [0,0,0,0],self.create_line(0,0,0,0, fill="white")],\
                               "BR3" :  [0, [0,0,0,0],self.create_line(0,0,0,0, fill="white")]}
        
        self.current_line = ["NULL" ,"NULL"]
    ...
    def draw_line(self, event): 
        ...
        if (not self.current_line == "NULL") and self._in_canvas :
            self.dict_rect[self.current_rect][1][2] = event.x/self.winfo_width()
            self.dict_rect[self.current_rect][1][3] = event.y/self.winfo_height()
