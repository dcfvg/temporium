...
class button_manuel(Frame):
    ...
    def __init__(self, parent):
        ...
        self.the_buttons = {'P_M1_BR1' : False, 'P_M1_BR2' : False, 'P_M1_BR3' : False,\
    ...
    def Button_P_BR1_BU1(self) :
        name = 'P_BR1_BU1'
        self.parent.current_state.P_BR1_BU1(not self.parent.current_state.state_pumps[name])

     
    def Button_P_BR2_BU2(self) :
        name = 'P_BR2_BU2'
        self.parent.current_state.P_BR2_BU2(not self.parent.current_state.state_pumps[name])
        
    def Button_P_BR3_BU3(self) :
        name = 'P_BR3_BU3'
        self.parent.current_state.P_BR3_BU3(not self.parent.current_state.state_pumps[name])
        
    def Button_P_BU1_AQ(self) :
        name = 'P_BU1_AQ'
        self.parent.current_state.P_BU1_AQ(not self.parent.current_state.state_pumps[name])
        
        
    def Button_P_BU2_AQ(self) :
        name = 'P_BU2_AQ'
        self.parent.current_state.P_BU2_AQ(not self.parent.current_state.state_pumps[name])
        
        
    def Button_P_BU3_AQ(self) :
        name = 'P_BU3_AQ'
        self.parent.current_state.P_BU3_AQ(not self.parent.current_state.state_pumps[name])
        
    def Button_P_M1_BR1(self) :
        name = 'P_M1_BR1'
        self.parent.current_state.P_M1_BR1(not self.parent.current_state.state_pumps[name])
        
    def Button_P_M1_BR2(self) :
        name = 'P_M1_BR2'
        self.parent.current_state.P_M1_BR2(not self.parent.current_state.state_pumps[name])

        
    def Button_P_M1_BR3(self) :
        name = 'P_M1_BR3'
        self.parent.current_state.P_M1_BR3(not self.parent.current_state.state_pumps[name])
       
    def Button_P_M2_BU1(self) :
        name = 'P_M2_BU1'
        self.parent.current_state.P_M2_BU1(not self.parent.current_state.state_pumps[name])
     
    def Button_P_M2_BU2(self) :
        name = 'P_M2_BU2'
        self.parent.current_state.P_M2_BU2(not self.parent.current_state.state_pumps[name])
        
    def Button_P_M2_BU3(self) :
        name = 'P_M2_BU3'
        self.parent.current_state.P_M2_BU3(not self.parent.current_state.state_pumps[name])
     
    def Button_P_M2_AQ(self):
        name = 'P_M2_AQ'
        self.parent.current_state.P_M2_AQ(not self.parent.current_state.state_pumps[name])
            
    def Button_P_AQ_S(self):
        name = 'P_AQ_S'
        self.parent.current_state.P_AQ_S(not self.parent.current_state.state_pumps[name])
